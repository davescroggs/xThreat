...
chains_processed['x_norm'] = chains_processed.x_norm.apply(lambda x: bound(-1,1,x)) * (167/2)
...
chains_processed['y_norm'] = chains_processed.y_norm.apply(lambda x: bound(-1,1,x)) * (123/2)
...
possession_summary = (chains_processed
                        ...
                        .agg(
                            ...
                            xInitialPoss = ('x_norm', 'first'),
                            yInitialPoss = ('y_norm', 'first'),
                            xFinalPoss = ('x_norm', 'last'),
                            yFinalPoss = ('y_norm', 'last'),
                            ...
                            xList = ('x_norm', lambda x: list(x)),
                            yList = ('y_norm', lambda x: list(x)),
...
possession_summary.to_pickle("data/possessions_processed_norm.pkl")
